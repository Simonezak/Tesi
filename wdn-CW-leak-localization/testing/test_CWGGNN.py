...
def run_CWGGNN_test(inp_path, model, num_test=100, num_steps=50, leak_area=0.1, K=10):
    ...
    for i in range(num_test):
        ...
        score_per_node, idx2node, leak_nodes = run_single_CWGGNN_test_episode(inp_path, model, num_steps, leak_area, num_leaks)
...
def run_single_CWGGNN_test_episode(inp_path, model, num_steps, leak_area, num_leaks):
...
if __name__ == "__main__":
    ...
    topo_mlp_ckpt = r"/home/zagaria/Tesi/Tesi/wdn-CW-leak-localization/saved_models/cw_ggnn.pt"
